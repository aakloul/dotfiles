...
vim.api.nvim_set_keymap("n", "<leader>h", "<cmd>lua htop_toggle()<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>p", "<cmd>lua python_toggle()<CR>", { noremap = true, silent = true })
