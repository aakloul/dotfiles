    ...
    s("@pytest_parametrize",
        {
            ...
            c(1, { t("given, expected"), t("entry1, entry2, expected") }), t("\", ["),
            t("", "\t["),
            t({ "", "\t(" }), d(2, get_node_value, { 1 }), t("),"),
            t({ "", "\t]", ")" }),
            t({ "", "def test_" }), i(3, "fname"), t("("), d(4, get_node_value, { 1 }), t("):"),
            t({ "", "\tassert " }), d(5, get_node_value, { 3 }), t("("),
            d(6, fn_arguments, { 1 }),
            t(")"), t(" == expected"),
        }
    ),
    ...
    s("def_test_fn",
        {
            ...
            t({ "def test_" }), i(1, "fname"), t("("), arguments_choice(2), t("):"),
            t({ "", "\tassert " }), d(3, get_node_value, { 1 }), t("("),
